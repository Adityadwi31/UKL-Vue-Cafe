            ...
            <div class="col">
              <div class="home_content text-center">
                ...
                <table class="table table-transparent">
                  ...
                  <tbody>
                    <tr class="text-light" v-for="(menu, nomor) in cart" :key="nomor">
                      <td>{{ nomor + 1 }}</td>
                      <td>{{ menu.nama_menu }}</td>
                      <td>{{ menu.total_pesanan }}</td>
                      <td>{{ menu.total_harga }}</td>
                      <td>
                        <button class="btn btn-outline-danger" @click="hapus(menu)">
                          Hapus
                        </button>
                      </td>
                    </tr>
        ...
        <div class="modal-content">
          ...
          <form @submit.prevent="checkoutnow">
            <div class="modal-body">
              ...
              <input type='text' required class="form-control" v-model="nama" id="user" readonly>
              ...
              <input type="text" class="form-control" v-model="checkout.nama_pelanggan" required autocomplete="off"
